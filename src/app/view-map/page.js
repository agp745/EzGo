...
import EzGoPic from "@/public/images/EzGoPic.png"
          ...
          <div className="flex h-screen flex-col justify-between pt-2 pb-6">
            <div>
              <div className="w-max p-2.5">
                <img src={EzGoPic} className="w-32" alt="" />
              </div>
              <ul className="mt-6 space-y-2 tracking-wide">
                <form action="" className="relative w-auto mx-auto">
                <input type="search" 
              class="peer cursor-pointer relative z-10 h-12 w-12 rounded-full border bg-transparent pl-12 outline-none text-gray-950 focus:w-full focus:cursor-text focus:border-cyan-300-300 focus:pl-16 focus:pr-4" />
        <svg xmlns="http://www.w3.org/2000/svg" class="absolute inset-y-0 my-auto h-8 w-12 border-r border-transparent stroke-gray-500 px-3.5 peer-focus:border-cyan-300-300 peer-focus:stroke-cyan-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
